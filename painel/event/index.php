        ...
        ?>
            ...
            <div class="sidebar">
                ...
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link regular btn-page" href="#" page="#certified-page">Certificados</a>
            ...
            <section id="main-menu">
                <div class="visor" class="container">
                    ...
                    <div id="certified-page" class="page">
                    <form action="../php/operations/generate-certifiers.php" method="post" >
                        <div class="row">
                            <h5 class="black green">Certificados</h5><?php // echo isset($_SESSION['message'])?>
                            <input type="hidden" name="event" value="<?php echo $event->getId(); ?>">
                            <button class='btn btn-large' type='submit' id="event-certified-btn" name="event-certified-btn">Gerar</button>
                        </div>
                        <label class="checkbox" >
                            <p class="black green"><input type="checkbox" id="checkAll" name="checkAll">Selecionar Todos</p>
                        </label>
                        <table id="participant-table">
                            <thead class="bold">
                                <tr>
                            ...
                            <tbody class="regular">
                                ...
                                foreach($participants as $participant) {
                                    ...
                                    ?>
                                <tr>   
                                    <td data-cpf="<?php echo $participant->getCpf(); ?>"><input type='checkbox' class='marcar' name='check[]' value="<?php echo $participant->getCpf();?>"/></td>
                                    <td><?php echo $participant->getName(); ?></td>
                                    <td><?php echo $participant->getCpf(); ?></td>
                                    <td><?php echo $participant->getEmail(); ?></td>
                                </tr>
